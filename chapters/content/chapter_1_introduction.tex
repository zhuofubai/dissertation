...
Chapter 3 presents a value based causal inference model for localizing faults in numerical software called NUMFL, which uses generalized propensity scores to control confounding bias.

Chapter 4 presents a new fault localization method based on  the Bayesian Additive Regression Tree model.

Chapter 5 presents an approach to automatically localize faulty statements in embedded control software.
