...
% \newpage
% Preface (optional)
\input{chapters/forward/acknowledgements}

\input{chapters/forward/list_of_abbreviations}

% % Glossary (optional)
% \newpage
% Glossary (optional)

\input{chapters/forward/abstract}
...
\input{chapters/content/chapter_1_introduction}

%\input{chapters/content/chapter_2_image2}
\input{chapters/content/chapter_3_malari}
%\input{chapters/content/chapter_4_phenotype}
%\input{chapters/content/chapter_5_cancer}
%\input{chapters/content/chapter_6_drug}
%\input{chapters/content/chapter_7_conclusion}
